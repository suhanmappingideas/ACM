...
/* The stacked chart shows the change of number of polygons belonging to each class intervals 
   The chart appears only when the map extent and the class intervals of all maps are same.
